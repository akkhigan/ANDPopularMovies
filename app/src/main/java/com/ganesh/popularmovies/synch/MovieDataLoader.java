package com.ganesh.popularmovies.synch;
...
public class MovieDataLoader {
    ...
    public void loadData(Context context) {
        ...
        if (AppUtils.getPreferredSortOrder(mContext) != null) {
            mSortByParamValue = AppUtils.getPreferredSortOrder(mContext);
        }
    ...
    private String[] loadMovieData() {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(MOVIES_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(API_KEY_PARAM, AppUtils.API_KEY)
                    .build();
    ...
    private String[] getMoviesDataFromJson(String moviesJsonStr)
        ...
        try {
            ...
            String[] favoriteMovieIds = AppUtils.loadFavoriteMovieIds(mContext);
            for (int i = 0; i < moviesArray.length(); i++) {
                JSONObject movieJSONObject = moviesArray.getJSONObject(i);

                String movieId = movieJSONObject.getString(OWM_ID);

                if (!AppUtils.isMovieIdFavorite(favoriteMovieIds, movieId)) {
...
//            http://api.themoviedb.org/3/movie/135397/reviews?api_key=28edec251247e1d7328ab3ec7f483cd0
    ...
    private void deleteOldData() {
        ...
        if (favoriteMovieIds != null && favoriteMovieIds.length > 0) {
            String favoriteMovieIdsString = AppUtils.argsArrayToString(favoriteMovieIds);
